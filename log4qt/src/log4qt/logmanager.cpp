...
namespace Log4Qt
{
    ...
    //void LogManager::qtMessageHandler(QtMsgType type,const QMessageLogContext& Context, const char *pMessage)
    void LogManager::qtMessageHandler(QtMsgType type,const QMessageLogContext& Context,
